...
const Portfolio = () => {
  ...
  return (
    ...
    <div id="portfolio-text-content" className="md:flex md:gap-10  md:items-center md:justify-between">
    <div id="portfolio-text" >
    <h1 className="md:text-5xl border-l-4 border-amber-500 pl-5 text-3xl py-2 mb-3  dark:text-white font-bold">my portfolio</h1>
